...
import com.superman.beijingweather.ui.girl.nestimageset.personalpictureset.PersonalPictureSetActivity;
 ...
 */
public class OneLevelAdapter extends RecyclerView.Adapter<OneLevelAdapter.GirlViewHolder> {

    private List<Girl> girls;
    private Context context;
    private LayoutInflater inflater;

    public OneLevelAdapter(Context context, List<Girl> list) {
        ...
        holder.iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(girl.getLink())) {
                    ...
                    Intent intent = PersonalPictureSetActivity.newIntent(context, girl.getLink(), "");
                    context.startActivity(intent);
                }
            }
        });
